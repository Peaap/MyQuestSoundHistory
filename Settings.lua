...
-- Ensure new config keys exist for existing users
if MQSH_Config.enableProgressText == nil then
    MQSH_Config.enableProgressText = true
end
...
local function CreateSoundAnouncerSettingsPanel()
    ...
    local progressTextCheck = CreateCheckbox(panel, L["PROGRESS_TEXT"], "enableProgressText", "TOPLEFT", progressCheck, "BOTTOMLEFT", 0, -45)
